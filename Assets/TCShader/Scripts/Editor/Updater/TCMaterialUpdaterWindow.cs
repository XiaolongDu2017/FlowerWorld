...
namespace TC.Shader.MaterialUpdater
{
	public class TCMaterialUpdaterWindow : EditorWindow
	{
		...
		{
			material.SetFloat (TCShaderEditorHelper.PROPERTY_RENDING_MODE, (float)shaderConfigData.RenderingMode);
			TCShaderEditorHelper.SetupMaterialWithRenderingMode (material, shaderConfigData.RenderingMode, true);
		...
		{
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialColor, TCShaderEditorHelper.PROPERTY_MAIN_COLOR);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialTexture, TCShaderEditorHelper.PROPERTY_MAIN_TEX);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_COLOR_FACTOR, "_BaseColorFactor");
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_CUTOFF);
		}
		...
		private static void UpdateMaterialSpecular (Material material, ShaderConfigData shaderConfigData, Material originalMaterial)
		{
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialColor, TCShaderEditorHelper.PROPERTY_SPEC_COLOR);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_SHININESS);
		...
		private static void UpdateMaterialReflection (Material material, ShaderConfigData shaderConfigData, Material originalMaterial)
		{
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialColor, TCShaderEditorHelper.PROPERTY_REFLECT_COLOR);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialTexture, TCShaderEditorHelper.PROPERTY_REFLECT_CUBE, "_Cube");
		...
		private static void UpdateMaterialRimWrap (Material material, ShaderConfigData shaderConfigData, Material originalMaterial)
		{
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialColor, TCShaderEditorHelper.PROPERTY_RIM_COLOR);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_RIM_POWER);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_WRAP_POWER);
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_LIGHT_POWER);
		...
		private static void UpdateMaterialDiscolor (Material material, ShaderConfigData shaderConfigData, Material originalMaterial)
		{
			...
			case TCShaderDiscolorMode.HslBlend:
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_HUE);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_SATURATION);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_LIGHTNESS);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_MIXING_FACTOR);

				_logger.LogFeature (UpdaterLogFeature.HslBlend);
				break;
			case TCShaderDiscolorMode.HueReplace:
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialColor, TCShaderEditorHelper.PROPERTY_HUE_COLOR, originalHuePropertyName);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_SATUR_MIN);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_SATUR_RATIO);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_SATUR_ADD);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_LIGHT_MAX);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_LIGHT_RATIO);
				UpdateMaterialProperty (material, originalMaterial, UpdateMaterialFloat, TCShaderEditorHelper.PROPERTY_LIGHT_ADD);
		...
		{
			var textureExists = ExistsMaterialTexture (material, TCShaderEditorHelper.PROPERTY_NORMAL_BUMP_MAP);
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialTexture, TCShaderEditorHelper.PROPERTY_NORMAL_BUMP_MAP);
		...
		{
			var textureExists = ExistsMaterialTexture (material, TCShaderEditorHelper.PROPERTY_TOONMAP_CUBE);
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialTexture, TCShaderEditorHelper.PROPERTY_TOONMAP_CUBE, "_ToonShade");
		...
		{
			var textureExists = ExistsMaterialTexture (material, TCShaderEditorHelper.PROPERTY_BOTTOM_TEX);
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialTexture, TCShaderEditorHelper.PROPERTY_BOTTOM_TEX);
		...
		private static void UpdateMaterialPropertyFactor (Material material, Material originalMaterial)
		{
			...
			UpdateMaterialProperty (material, originalMaterial, UpdateMaterialTexture, TCShaderEditorHelper.PROPERTY_FACTOR_TEX, "_PropertyTex");
			_shouldUpdatePropertyFactor = false;
		}
